...
<meta name="apple-mobile-web-app-title" content="Valdeweb">
<meta name="application-name" content="Valdeweb">
...
<div class="wrapper" id="wrapper">
  ...
  <section class="aboutme" id="aboutme">
    <div class="container">
      <div class="heading">
        <h2>About us</h2>
        <p>A small introduction about us</p>
      </div>
      <div class="row">
        <div class=" col-xs-12 col-sm-12 col-md-7 col-lg-7">
          <h3>Valdeweb</h3>
          <h4 class="subHeading">Webdesign & Web Develope from Rawson</h4>
        ...
        <div class=" col-xs-12 col-sm-12 col-md-4 col-lg-4 col-md-offset-1 col-lg-offset-1 proPic"> <img src="../assets/images/profile.gif" alt="" class="img-circle topmar"> </div>
      </div>
    </div>
  </section>
  <!--about me end-->
    ...
    <div class="container">
      ...
      <div class="row">
        <div class=" col-xs-12 col-sm-4 col-md-4 col-lg-4 skillsArea">
          <div class=" col-xs-12 col-sm-6 col-md-6 col-lg-6 skills"> <span class="chart skilBg" data-percent="72"> <span class="percent"></span> </span>
            <h4>ANSI C</h4>
        ...
        <div class=" col-xs-12 col-sm-4 col-md-4 col-lg-4 skillsArea">
          <div class=" col-xs-12 col-sm-6 col-md-6 col-lg-6 skills"> <span class="chart skilBg" data-percent="62"> <span class="percent"></span> </span>
            <h4>Flash</h4>
            <p>Donec accumsan ligula vitae mag na curabitur id</p>
          </div>
        </div>
        <div class=" col-xs-12 col-sm-4 col-md-4 col-lg-4 skillsArea">
          <div class=" col-xs-12 col-sm-6 col-md-6 col-lg-6 skills"> <span class="chart skilBg" data-percent="86"> <span class="percent"></span> </span>
            <h4>HTML5 / CSS3</h4>
            <p>Donec accumsan ligula vitae mag na curabitur id</p>
          </div>
        </div>
        <div class=" col-xs-12 col-sm-4 col-md-4 col-lg-4 skillsArea">
          <div class=" col-xs-12 col-sm-6 col-md-6 col-lg-6 skills"> <span class="chart skilBg" data-percent="84"> <span class="percent"></span> </span>
            <h4>jQuery</h4>
            <p>Donec accumsan ligula vitae mag na curabitur id</p>
          </div>
        </div>
        <div class=" col-xs-12 col-sm-4 col-md-4 col-lg-4 skillsArea">
          <div class=" col-xs-12 col-sm-6 col-md-6 col-lg-6 skills"> <span class="chart skilBg" data-percent="91"> <span class="percent"></span> </span>
            <h4>PHP / MySQL</h4>
            <p>Donec accumsan ligula vitae mag na curabitur id</p>
          </div>
        </div>
...
<p> <i class="fa fa-map-marker fa-lg"></i> Collins Street West Victoria 8007 Australia</p>
      ...
      <div class="col-xs-12 col-sm-9 col-md-8 col-lg-8 conForm">
        ...
        <div id="message"></div>
        <form method="post" action="../assets/php/contact.php" name="cform" id="cform">
